window.onload = function () {
    ...
    // Si rpiPhotonConfig no está definido, inicialízalo como un arreglo vacío
    const IMAGE_CONFIGS = (typeof rpiPhotonConfig !== 'undefined') ? JSON.parse(rpiPhotonConfig.imageConfigs) : [];
    
    console.log(JSON.parse(rpiPhotonConfig.imageConfigs));
